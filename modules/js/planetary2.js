...
function changeSpeed(value){
  ...
  console.log(compositeArray[1].motorSpeed)
}
...
mediumGear((window.innerWidth)*(0.75*0.5)-160,(window.innerHeight)*0.5)
mediumGear((window.innerWidth)*(0.75*0.5)+160,(window.innerHeight)*0.5)
mediumGear((window.innerWidth)*(0.75*0.5),(window.innerHeight)*0.5+160)
mediumGear((window.innerWidth)*(0.75*0.5),(window.innerHeight)*0.5-160)
