...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" action="">
		...
		<!-- <fieldset class="usp-name">
			<label for="user-submitted-name"><?php _e('Tools', 'usp'); ?></label>
			<input name="user-submitted-name" type="text" value="" placeholder="<?php _e('Tool', 'usp'); ?>"<?php if (usp_check_required('usp_name')) echo $required; ?> class="usp-input">			
			<?php
			    function makeTextInputField() {
			        echo "
			            <input name='user-submitted-title' type='text' value='' placeholder='Tool' class='usp-input' />
			        ";
			    }
			?>
			<?php makeTextInputField(); ?>
			<?php makeTextInputField(); ?>
			<?php makeTextInputField(); ?>
			<?php makeTextInputField(); ?>
		</fieldset> -->
		<!-- <a href="#" id="add-tool">Add Another Tool</a> -->



		<?php }?> <?php if ($usp_options['usp_content'] == 'show' || $usp_options['usp_content'] == 'optn') { ?>
		...
		<fieldset class="usp-content">
			...
			<label for="user-submitted-content"><?php _e('Description', 'usp'); ?></label>
			<textarea name="user-submitted-content" rows="5" placeholder="<?php _e('Description', 'usp'); ?>"<?php if (usp_check_required('usp_content')) echo $required; ?> class="usp-textarea"></textarea>
			<?php } ?>
		...
		<fieldset class="usp-tags">
			<label for="user-submitted-tags"><?php _e('Tags', 'usp'); ?></label>
			<input name="user-submitted-tags" type="text" value="" placeholder="<?php _e('Tags', 'usp'); ?>"<?php if (usp_check_required('usp_tags')) echo $required; ?> class="usp-input">
		</fieldset>
