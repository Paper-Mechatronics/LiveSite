    ...
    <div class = "container">
        ...
        <div class = "controls">
            <div class = "checkboxes">
                <p>Pairing Gears</p>
                <input id = "pairing" class = "checkbox" type="checkbox" onclick="pairingGear()"></button>
            </div>
            <div class = "checkboxes">
                <p>Merge Pinion Gear</p>
                <input id = "mergePinion" class = "checkbox" type="checkbox" onclick="mergePinion()"></button>
            </div>
        </div>
        <div class = "controls-dark">
            <div>
