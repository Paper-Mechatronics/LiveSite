  ...
  <body>
    ...
    <div class = "container">
        ...
        <div class = "controls-dark">
            ...
            <div>
                <p>Driver Gear:</p>
                <button class = "object btn btn-primary" type="button" id="setSmallGear" onclick="motorL()">Left</button>
                <button class = "object btn btn-primary" type="button" id="setMedGear" onclick="motorR()">Right</button>
            </div>
            <br>
            <div>
            <p>Motor Rotation:</p>
